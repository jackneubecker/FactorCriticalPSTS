...
starter_triples = txt_to_list_of_triples('19/PSTS_19_36_57/data/starter_triples.txt',str_to_int=True)
...
APCs = txt_to_dict_of_APCs('19/PSTS_19_36_57/data/APCs.txt', str_to_int=True)

is_APCs_checker(APCs, point_set)
has_APCs_checker(triples, APCs)

extra_starter_triples = txt_to_list_of_triples('19/PSTS_19_36_57/data/extra_starter_triples.txt',str_to_int=True)
extra_triples = []
