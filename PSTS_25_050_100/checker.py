...
def checker(): 
    ...
    starter_triples = txt_to_list_of_triples('PSTS_25_050_100/data/starter_triples.txt',str_to_int=True)
    ...
    APCs = txt_to_dict_of_APCs('PSTS_25_050_100/data/APCs.txt', str_to_int=True)

    is_APCs_checker(APCs, list(range(n)))
    has_APCs_checker(triples, APCs)

    extra_starter_triples = txt_to_list_of_triples('PSTS_25_050_100/data/extra_starter_triples.txt',str_to_int=True)
